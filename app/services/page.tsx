...
export default function ServicesPage() {
  return (
    <>
      ...
      <style>{`
        .services-hero{background:#07152f;color:#fff;padding:78px 0 82px;overflow:hidden;position:relative;isolation:isolate}
        .services-hero:before{content:"";position:absolute;inset:0;background-image:linear-gradient(90deg,rgba(7,21,47,.99) 0%,rgba(7,21,47,.94) 30%,rgba(7,21,47,.68) 57%,rgba(7,21,47,.34) 100%),url("https://images.unsplash.com/photo-1494412574643-ff11b0a5c1c3?auto=format&fit=crop&w=2200&q=90");background-size:cover;background-position:center right;z-index:-2}
        .services-hero:after{content:"";position:absolute;inset:0;background:linear-gradient(135deg,rgba(7,21,47,.18),transparent 45%,rgba(255,106,0,.08)),radial-gradient(circle at 78% 25%,rgba(255,106,0,.17),transparent 28%);z-index:-1}
        ...
        .services-hero h1{margin:0;max-width:800px;font-size:clamp(46px,6.5vw,78px);line-height:.94;letter-spacing:-.055em;font-weight:900;text-shadow:0 3px 24px rgba(0,0,0,.16)}
        .services-hero h1 span{color:var(--orange)}
        .services-hero p{max-width:720px;margin:25px 0 0;color:#dce7f7;font-size:17px;line-height:1.7;text-shadow:0 2px 12px rgba(0,0,0,.3)}
        .services-hero-note{border-left:1px solid rgba(255,255,255,.28);padding:8px 0 8px 24px;display:grid;gap:10px;background:rgba(7,21,47,.18);backdrop-filter:blur(4px)}
        ...
        @media(max-width:900px){.services-hero-grid{grid-template-columns:1fr;gap:30px}.services-hero-note{border-left:0;border-top:1px solid rgba(255,255,255,.2);padding:20px 0 0}.service-detail{grid-template-columns:1fr}.service-detail-media{min-height:300px}.service-detail-content{padding:32px}.capability-list{grid-template-columns:1fr 1fr}.services-hero:before{background-position:62% center}}
        @media(max-width:640px){.services-hero{padding:58px 0 62px}.services-hero h1{font-size:clamp(42px,13vw,62px)}.services-hero p{font-size:15px}.service-detail-media{min-height:230px}.service-detail-content{padding:27px 23px}.service-detail-content h3{font-size:29px}.capability-list{grid-template-columns:1fr}.service-quote-btn{width:100%}.services-hero:before{background-image:linear-gradient(90deg,rgba(7,21,47,.98),rgba(7,21,47,.86)),url("https://images.unsplash.com/photo-1494412574643-ff11b0a5c1c3?auto=format&fit=crop&w=1400&q=85");background-position:65% center}}
      `}</style>
    </>
  );
}