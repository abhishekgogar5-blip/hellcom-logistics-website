        ...
        <div className="container split">
          <div>
            ...
            <div className="checks">
              ...
              <div className="check"><div className="check-mark">W</div><div><strong>WhatsApp</strong><div className="muted">Add your business WhatsApp number before launch.</div></div></div>
            </div>
          </div>
