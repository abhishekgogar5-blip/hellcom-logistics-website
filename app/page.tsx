  ...
  return (
    <>
      ...
      <style>{`
        ...
        @media(max-width:640px){.home-services-marquee{padding:8px 0 18px}.home-services-track{gap:16px;padding:0 20px}.home-service-card{width:285px;flex-basis:285px}.home-services-mobile-note{display:block}}
